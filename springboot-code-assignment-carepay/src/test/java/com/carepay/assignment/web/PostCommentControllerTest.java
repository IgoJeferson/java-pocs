...
public class PostCommentControllerTest extends IntegrationTest {
    @Test
    ...
    void commentTooLong() throws Exception {
        mvc.perform(
                post("/posts/{postId}/comments", 1)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"comment\":\"\"}")
        )
